  ...
  return (
    ...
    >
      <div className="w-[51.8%] h-full  flex  items-center max-md:w-[63%] max-sm:w-full max-sm:justify-center">
        <div className="bg-[#0F0F0F] rounded-[10px] mb-20 max-sm:mb-0 max-md:mb-60 h-full max-h-[322px] w-full max-w-[86.31%] max-md:max-w-[380px] max-md:h-[297px]  bg-opacity-[33%]  flex justify-center items-center">
