  ...
  return (
    <div className="w-full flex justify-center pb-[83px] pt-[246px]">
      <div className="flex h-full justify-center items-center gap-[88px] max-md:gap-[64px] flex-col w-[83.89%] max-md:w-[89.58%] max-sm:w-[70.82%]">
        ...
        <div className="flex w-full h-[360px] max-md:h-full gap-[64px] max-md:flex-col">
          <div
          ...
          >
            {/* <div className="text-[40px] leading-[120%] font-raleway font-bold text-[#000000] max-w-[48.06%]  text-center">
              MARBLE FINISH
            </div> */}
            <div
        ...
        <div className="flex w-full max-md:h-full h-[360px] gap-[64px] max-md:flex-col">
          <div
            className="rounded-[50%] w-full h-full max-md:h-[300px] flex items-center justify-center"
            style={{
        ...
        <div className="flex w-full h-[360px] gap-[64px] max-md:hidden">
          <div
            className="rounded-[50%] w-full h-full flex items-center justify-center"
            style={{
